...
const menuItems: MenuItem[] = [
  ...
  { label: "Project", ariaLabel: "Our projects", link: "/projects" },
  { label: "Contact Us", ariaLabel: "Get in touch", link: "/contact" },
  { label: "Flats", ariaLabel: "Get in touch", link: "/flats" },
  { label: "Properties", ariaLabel: "Get in touch", link: "/properties" },
